...
CONFIG_SCHEMA: list[tuple[str, str, str, str]] = [
    ...
    ("llm.deepseek_model", "llm", "DeepSeek 模型", "deepseek-v4-flash"),
...
# 各服务商可选模型版本（用于前端下拉选择，已同步各厂商官方最新模型）
